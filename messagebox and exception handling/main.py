...
# label frame
label_frame = ttk.LabelFrame(root, text="Contact Details")
...
def submit():
    ...
    if age == '' or name == '':
        ...
        try:
            ...
            m_box.showerror('Value Error', 'Only Digits are allowed in Age !')

        else:
            if age < 18:
                m_box.showwarning('Age Restricted', 'You are not allowed to access this content !!')
                exit()
